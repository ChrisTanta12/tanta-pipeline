...
const CYCLES: Cycle[] = [
  ...
  },
  {
    ...
    drawingsChris: 5000.00,
    drawingsAnthony: 5000.00,
    accountBalancesEnd: {},
    flags: [
      ...
      { severity: 'warn', title: 'Drawings well above prescribed', body: 'Drawings of $5,000 each ($10,000 total) on 22/04 vs prescribed $1,648 (45% of $3,662 income). Buffer cash from prior fortnights covered the maths. The additional $500 each to Chris/Ant Expenses cards is counted as opex (director expense float), not drawings.' },
    ...
    notes: 'Trail-heavy fortnight (only AJG $2,828.62 was upfront). No live PF transfers — retroactive Opex sweep of $7,827.26 booked on 06/05 (no Salaries / Tax / Profit split). Drawings of $5,000 each happened live on 22/04 from Opex 8.1K; $500 each to Chris/Ant Expenses cards counted as opex (director expense float), not drawings.',
  },
  {
    ...
    flags: [
      ...
      { severity: 'ok', title: '06/05 catch-up transfers landed', body: 'Opex $13,679.74 (49%), Salaries $12,563.03 (45%), Profit $558.36 (2%) all moved on 06/05. Drawings of $5,000 each followed from Opex 8.1K the same day. $500 each to Chris/Ant Expenses cards counted as opex (director expense float), not drawings.' },
