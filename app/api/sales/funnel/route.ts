...
import { loadOpportunities, loadStageHistory } from '@/app/lib/sales/db';
import { computeFunnel } from '@/app/lib/sales/metrics';
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(computeFunnel(opps, history, days), {
